...
public class ProductsController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<Guid>>> GetProductIds(CancellationToken cancellationToken)
    {
        var ids = await _productService.GetAllProductIdsAsync(cancellationToken);
        return Ok(ids);
    }
}
